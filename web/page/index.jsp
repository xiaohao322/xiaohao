...
<div class="layui-layout layui-layout-admin">
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a target="iframe_context" href="doSup?action=getAdmin&id=${sessionScope.admlogin.id}">基本资料</a></dd>
            ...
            <ul id="left2" class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a target="iframe_context"  href="doSup?action=unionQuery&pageNumber=1&username=&userid=&usersex=">查询顾客</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe621;&nbsp;&nbsp;分类管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doSup?action=queryAllBigClass&pageNumber=1">大分类管理</a></dd>
                        <dd><a target="iframe_context" href="doSup?action=unionSmallClass&pageNumber=1&likeval=&b_id=">小分类管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe621;&nbsp;&nbsp;商品管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doSup?action=unionQgoods&pageNumber=1&likeval=&sm_id=&d_id=">查询商品</a></dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doSup?action=queraunn&pageNumber=1">查询公告</a></dd>
    ...
    <div id="main" class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <iframe name="iframe_context" frameborder="0" id="context" src="doStu?action=queryPageAll&pageNumber=1"  ></iframe>
        </div>
    </div>
